...
# ############################calculate the tfidf for train data##########################
tfidf = []
...
train_data.to_csv("./data_preprocessing/train_data_alg3.csv",index=0)


# ############################calculate the tfidf for dev data##########################
tfidf_dev = []
...
dev_data.to_csv("./data_preprocessing/dev_data_alg3.csv",index=0)



# ############################calculate the tfidf for test data##########################
tfidf_test = []
...
test_data.to_csv("./data_preprocessing/test_data_alg3.csv",index=0)



# ############################Algorithm 3: train the model and test ##########################
